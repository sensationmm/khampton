...
$("document").ready(function() {
    ...
    $productGalleryThumbs.click(function() {
        ...
        $("#" + $productGalleryActive).animate({
            opacity: "0"
        }, 750).css("zIndex", 1);
        $('[rel="' + $productGalleryActive + '"]').css("opacity", .4);
        $("#" + $target).animate({
            opacity: "1"
        }, 750).css("zIndex", 2);
    ...
    $sizeGuide.click(function() {
        $overlay.fadeIn("fast");
        $overlaySizeGuide.css("display", "block").animate({
            opacity: "1",
            top: "50%"
        }, 500);
    });
    $overlaySizeGuideClose.click(function() {
        $overlaySizeGuide.animate({
            opacity: "0",
            top: "55%"
        }, 500, function() {
            setTimeout(function() {
