	...
	<?php else : ?>
		...
		<?php foreach ( $attributes as $attribute_name => $options ) : ?>
			...
			<?php
				...
				/*echo '<div style="display:none;">';wc_dropdown_variation_attribute_options(array('options' => $options, 
																'attribute' => $attribute_name, 
																'product' => $product, 
																'selected' => $selected));echo '</div>';*/

				wc_dropdown_variation_attribute_options2(array('options' => $options, 
																'attribute' => $attribute_name, 
																'product' => $product, 
																'selected' => $selected));
